...
export function Environment(name: string): BaseURL {
    return `https://${name}-encore-nextjs-8ue2.encr.app`
}
...
/**
 * Client is an API client for the encore-nextjs-8ue2 Encore application. 
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "encore-nextjs-8ue2-Generated-TS-Client (Encore/v1.41.4)";
        }
